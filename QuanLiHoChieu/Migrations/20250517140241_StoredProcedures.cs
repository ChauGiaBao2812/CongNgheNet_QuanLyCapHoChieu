...
namespace QuanLiHoChieu.Migrations
{
    ...
    public partial class StoredProcedures : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                CREATE PROCEDURE sp_InsertPassportData
                    @FormID NVARCHAR(20),
                    @CCCD VARCHAR(20),
                    @HoTen NVARCHAR(100),
                    @GioiTinh NVARCHAR(10),
                    ...
                    @DiaChiCoQuan NVARCHAR(100) = NULL,
                    @HoTenCha NVARCHAR(100) = NULL,
                    @NgaySinhCha DATE = NULL,
                    @HoTenMe NVARCHAR(100) = NULL,
                    @NgaySinhMe DATE = NULL,
                    @NoiDungDeNghi NVARCHAR(MAX),
                    @NoiTiepNhanHS NVARCHAR(100),
                    @NgayNop DATE
                AS
                BEGIN
                    BEGIN TRY
                        ...
                        INSERT INTO PassportData (
                            FormID, CCCD, HoTen, GioiTinh, NgaySinh, NoiSinh, NgayCap, NoiCap, DanToc, TonGiao, SĐT,
                            ttTinhThanh, ttQuanHuyen, ttPhuongXa, ttSoNhaDuong,
                            thtTinhThanh, thtQuanHuyen, thtPhuongXa, thtSoNhaDuong,
                            NgheNghiep, CoQuan, DiaChiCoQuan,
                            HoTenCha, NgaySinhCha, HoTenMe, NgaySinhMe,
                            NoiDungDeNghi, NoiTiepNhanHS, NgayNop
                        )
                        VALUES (
                            @FormID,
                            ENCRYPTBYKEY(KEY_GUID('SymmetricKey_AES'), CONVERT(VARCHAR(20), @CCCD)),
                            ...
                            ENCRYPTBYKEY(KEY_GUID('SymmetricKey_AES'), @thtPhuongXa),
                            ENCRYPTBYKEY(KEY_GUID('SymmetricKey_AES'), @thtSoNhaDuong),
                            ENCRYPTBYKEY(KEY_GUID('SymmetricKey_AES'), @NgheNghiep),
                            ENCRYPTBYKEY(KEY_GUID('SymmetricKey_AES'), @CoQuan),
                            ENCRYPTBYKEY(KEY_GUID('SymmetricKey_AES'), @DiaChiCoQuan),
                            ENCRYPTBYKEY(KEY_GUID('SymmetricKey_AES'), @HoTenCha),
                            @NgaySinhCha,
                            ENCRYPTBYKEY(KEY_GUID('SymmetricKey_AES'), @HoTenMe),
                            @NgaySinhMe,
            ...
            migrationBuilder.Sql(@"
                CREATE PROCEDURE sp_SelectPassportData
                AS
                BEGIN
                    EXEC sp_OpenSymmetricKey;
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS sp_InsertPassportData;");
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS sp_SelectPassportData;");
        }
